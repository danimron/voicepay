...
- July 02, 2025: Enhanced voice system with speech resumption - added pause/resume functionality to speech synthesis, speech automatically resumes when voice listening stops, implemented onSpeechResume callback for seamless voice interaction flow
